export function GridLayout() {
  return (
    <div className='grid grid-cols-1 sm:grid-cols-3 gap-4 p-4 border-2 border-border rounded-lg bg-muted w-full max-w-md'>
      ...
      <div className='sm:col-span-2 h-20 bg-chart-4 border-2 border-border rounded shadow-[2px_2px_0px_0px_var(--color-border)]' />
